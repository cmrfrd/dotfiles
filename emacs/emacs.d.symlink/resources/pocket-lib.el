...
(defcustom pocket-lib-token-file (expand-file-name "~/.pocket-api-auth.json")
  ...
  (if (or (null pocket-lib--access-token)
      ...
      (progn
        (if (and pocket-lib--access-token-have-opened-browser
          ...
          (let ((url (concat "https://getpocket.com/v3/oauth/authorize?request_token=" request-token)))
