...
#+BEGIN_SRC emacs-lisp
      (use-package elscreen
        :config
        (custom-set-variables '(elscreen-tab-display-kill-screen nil) ; hide kill button
...
** Use =doom-modeline= for pretty modeline
   ...
   #+RESULTS:
   | global-company-mode | doom-modeline-mode | x-wm-set-size-hint | table--make-cell-map | emojify-download-emoji-maybe |
